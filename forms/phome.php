...
<head>
  ...
  <link rel='stylesheet prefetch' href='http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css'>
    ...
    <style>
    .sub{background-color:cornflowerblue;
        ...
        h4{color:blue;}
        .blue{color: blue;}
        body{background-image: url('../images/dr2.jpg');}
...
<div class="container">
 ...
 <div class="input-group input-group-icon">
   ...
   <h4>Give a clear description of your illness.</h4>
       ...
       <div class="row">
      <div class="input-group input-group-icon">
        <input type="text" placeholder="Description (it's optional)"/>
      ...
      <input type="submit" name="submit" value="Get Prescription" class="sub"/>
           </h4>
      </div>
